...
Through renewed funding from the National Science Foundation ([DRL-2321128](#0), and [DRL-2321129](#0)), the next iteration of the LASER Institute: Broadening Education in Advanced Methods (LASER BEAM) aims to greatly expand the the number of education researchers capable of leveraging advanced research methods to understand and improve student learning. To support participants in both learning and teaching with the LASER curriculum, this grant has three major activities designed to broaden the impact of this work:
