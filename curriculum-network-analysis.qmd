...
+---------------------------------------+---------------------+--------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/sna-micro.jpg){width="40"} | **Microcredential** | [Social Network Analysis and Education](https://laser-institute.github.io/network-analysis/microcredential/sna-microcredential.html) |
+---------------------------------------+---------------------+--------------------------------------------------------------------------------------------------------------------------------------+
