...
|                                                 | Overview**        |                                                                                                                                                                                                                                         |
+-------------------------------------------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/code-along.png){width="40"}          | **Code Along**    | [BKT via ASSISTments](https://www.assistments.org/account/login) \| [BKT-BF for PC](https://yilinliu.quarto.pub/module-1-bkt-bf-walkthrough-windows/) \| [BKT-BF for Mac](https://yilinliu.quarto.pub/module-1-bkt-bf-walkthrough-mac/) |
+-------------------------------------------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/reading.png){width="40"}             | **Readings &\     | [Essential Readings](https://yilinliu.quarto.pub/kt-introduction/#/references)                                                                                                                                                          |
|                                                 | Reflection**      |                                                                                                                                                                                                                                         |
+-------------------------------------------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/case-study.png){width="40"}          | **Case Study**    | [BKT with Python](https://posit.cloud/spaces/493094/join?access_code=qjsumVzA0HZYgrxOSizVbVPmDs7iHYS32yUQaqDe) \| [Answer Key](https://yilinl.quarto.pub/intro-to-bkt/)                                                                 |
+-------------------------------------------------+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
There is one additional set of module assets available for this course for those wishing to pursue additional learning about knowledge tracing. These assets for Module 5 (Memory Algorithms) can be found on the [LASER GitHub](https://github.com/laser-institute/knowledge-tracing/tree/main/Module-5c-MA).
