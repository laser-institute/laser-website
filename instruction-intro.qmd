...
- [**S**]{.underline}pecific. Identify specific learning analytics topics and/or techniques to teach others; 

- [**H**]{.underline}ow to. Develop a plan for how to incorporate LASER materials into this instructional experience;

- [**A**]{.underline}ttainable. Ensure the plan is attainable during the academic year, preferably fall semester; 

- [**R**]{.underline}elevant. Make sure the plan is relevant to their professional goals; and,

- [**K**]{.underline}eep track. Help to keep track of feedback, information, and insights gained to help improve the curriculum. 
