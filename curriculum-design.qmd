...
|---------------|---------------|---------------|---------------|---------------|
| **The Learning Analytics Workflow** | Characteristics of Data | The Power of Data Visualization | Learning Analytics Methods | Data Products |
| **Machine Learning** | Supervised Machine Learning | Training and Testing Data | Interpreting Prediction Metrics | Model Improvement |
| **Structure Discovery** | Structure Discovery Basics | Clustering | Clustering Validation | Advanced Clustering Algorithms |
| **Relationship Mining** | Correlation Mining | Association Rule Mining | Sequential Pattern Mining |  |
| **Knowledge Tracing** | Bayesian Knowledge Tracing | Performance Factor Analysis | Item Response Theory | Deep Knowledge Tracing |
| **Social Network Analysis** | Network Analysis for Newbies | Network Management & Measurement | Groups, Positions, & Egocentric Analysis | Statistical Inference & Network Models |
| **Text Mining** | Text Mining Basics | Dictionary-Based Methods | Topic Modeling | Quantitative Ethnography |

There are topics within and across all modules designed to deepen learners' understanding of LA approaches, applications, and legal and ethical issues. Topics will include but are not limited to:

- Reproducible research and open-science standards

- Types of data used in LA and the methods for their collection

- Applications of LA to STEM educational contexts such as recommendation and intelligent tutoring systems, adaptive learning and curriculum design, and students at risk of failing a course

- Legal and ethical considerations such as student privacy, data ethics and algorithmic bias.

In addition, learners are introduced to frameworks and approaches such as research-practice partnerships to prepare them to work closely with educational organizations to improve STEM outcomes at the local, district and state level.
