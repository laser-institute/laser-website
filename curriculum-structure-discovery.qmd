...
## Module 1: Structure Discovery Basics

This module contains:

- A slide-based overview introducing the core concepts of structure discovery. This includes key distinctions between supervised machine learning (ML) from unsupervised ML, as well as an overview of common unsupervised ML techniques (e.g., clustering, dimensionality reduction), and examples of real-world applications.
