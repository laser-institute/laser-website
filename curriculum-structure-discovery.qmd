...
There are two additional sets of module assets available for this course for those wishing to pursue additional learning about structure discovery. Please find the assets for Module 5 (Factor Analysis) and Module 6 (Q-Matrices) on the [LASER GitHub](https://github.com/laser-institute/structure-discovery).
