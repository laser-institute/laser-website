...
![](images/clipboard-597418987.jpeg){width="20%"}
...
+---------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/clipboard-3701678983.jpeg){width="40"} | [**Badge Activity**](https://laserkt.quarto.pub/module-1-badge-discovering-patterns-without-labels-03e7/)                                                               |
+---------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
- A self-paced badge activity to connect clustering to your own research or teaching practices.
...
| ![](images/case-study.png){width="40"}            | **Case Study**                                                                                                                                |
+---------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/clipboard-3041204011.jpeg){width="40"} | [**Badge Activity**](https://laserkt.quarto.pub/module-2-badge-activity-094f/)                                                                |
+---------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
| ![](images/survey.png){width="47" height="40"}    | [**Module Survey**](https://www.surveymonkey.com/r/LAWF_Mod4_July24)                                                                          |
+---------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------+
...
| ![](images/case-study.png){width="40"}            | **Case Study**                                                                 |
+---------------------------------------------------+--------------------------------------------------------------------------------+
| ![](images/clipboard-1238045399.jpeg){width="40"} | [**Badge Activity**](https://laserkt.quarto.pub/module-3-badge-activity-2b85/) |
+---------------------------------------------------+--------------------------------------------------------------------------------+
...
| ![](images/case-study.png){width="40"}            | **Case Study**                                                                 |
+---------------------------------------------------+--------------------------------------------------------------------------------+
| ![](images/clipboard-2193977185.jpeg){width="40"} | [**Badge Activity**](https://laserkt.quarto.pub/module-4-badge-activity-27bc/) |
+---------------------------------------------------+--------------------------------------------------------------------------------+
| ![](images/survey.png){width="47" height="40"}    | **Module Survey**                                                              |
+---------------------------------------------------+--------------------------------------------------------------------------------+
...
There are two additional sets of module assets available for this course for those wishing to pursue additional learning about structure discovery via unsupervised machine learning. Please find the assets for Module 5 (Factor Analysis) and Module 6 (Q-Matrices) on the [LASER GitHub](https://github.com/laser-institute/structure-discovery). While they are not directly rendered on this website, they should be complete and able to be rendered and published via RStudio or similar IDEs.
